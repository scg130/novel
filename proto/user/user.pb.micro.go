...
type UserCenterService interface {
	...
	Find(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error)
}
...
func (c *userCenterService) Login(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "UserCenter.Login", in)
	out := new(Response)
...
func (c *userCenterService) Register(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "UserCenter.Register", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (c *userCenterService) Find(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "UserCenter.Find", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func RegisterUserCenterHandler(s server.Server, hdlr UserCenterHandler, opts ...server.HandlerOption) error {
	type userCenter interface {
		...
		Find(ctx context.Context, in *Request, out *Response) error
	}
...
func (h *userCenterHandler) Login(ctx context.Context, in *Request, out *Response) error {
	return h.UserCenterHandler.Login(ctx, in, out)
}

func (h *userCenterHandler) Register(ctx context.Context, in *Request, out *Response) error {
	return h.UserCenterHandler.Register(ctx, in, out)
}

func (h *userCenterHandler) Find(ctx context.Context, in *Request, out *Response) error {
	return h.UserCenterHandler.Find(ctx, in, out)
}
